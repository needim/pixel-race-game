...
name='guest';var leaderboard=new Clay.Leaderboard({id:2618});leaderboard.post({score:parseInt(that.score.floor().toString()),name:name},function(response){});}
return;}
if(this.speed<100)

...
if(this.gameOver){var that=this;var player=Clay.Player;if(!that.isSubmitted){that.isSubmitted=true;console.log(player);var leaderboard=new Clay.Leaderboard({id:2618});leaderboard.post({score:parseInt(that.score.floor().toString())},function(response){console.log(response);leaderboard.fetch({limit:100,getRank:true},function(results){console.log(results);});});}
return;}
if(this.speed<100)

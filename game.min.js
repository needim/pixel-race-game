...
this.speed+=(ig.system.tick*(150/this.speed))+0.1;this.screen.y-=ig.system.tick*this.speed;this.player.pos.y-=ig.system.tick*this.speed;var walls=ig.game.getEntitiesByType(EntityWall);var coins=ig.game.getEntitiesByType(EntityCoin);if(this.screen.y<-1){var row=this.getRow();this.screen.y+=8;this.player.pos.y+=8;for(var k=0;k<=8;k++){if(row[k]){var x,y;if(Math.random()>0.80){y=-28;x=k*8;this.spawnEntity(EntityCoin,x,y);}else{y=-28;x=k*8;this.spawnEntity(EntityWall,x,y);}}}
